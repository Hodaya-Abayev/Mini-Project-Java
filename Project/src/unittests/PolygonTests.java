...
public class PolygonTests {
    ...
    public void testfindIntersections() throws Exception 
    {
    	...
    	assertEquals("Inside polygon",new Point3D(0, 0, 0.6),tr.findIntsersections(new Ray(new Point3D(3,0,0),new Vector(-5,0,1))).get(0).point);
        ...
        //TC03:On edge's continuation
     	...
     	//TC04:On The edge
     	assertEquals("On The edge",new Point3D(0, 0,1),tr.findIntsersections(new Ray(new Point3D(-1,0,1),new Vector(1,0,0))).get(0).point);
     	//TC05:On The vertex
     	assertEquals("On The vertex",new Point3D(0, 0,2),tr.findIntsersections(new Ray(new Point3D(-1,0,2),new Vector(1,0,0))).get(0).point);
